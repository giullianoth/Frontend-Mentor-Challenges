...
*Esta é uma solução para o desafio [Product preview card component do Frontend Mentor](https://www.frontendmentor.io/challenges/product-preview-card-component-GO7UmttRfa). Os desafios do Frontend Mentor te ajudam a aprimorar suas habilidades de codificação através da elaboração de projetos realísticos.*
